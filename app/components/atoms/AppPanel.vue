 ...
 * 使用者自己按過了沒有。
 *
 * 環境的意見會晚一步到：掛載以前量不到視窗，所以第一次畫出來的一律是寬螢幕那一版，
...
<template>
  ...
  >
    ...
    <!--
      收起來時內容整塊不顯示（display: none），而不是把高度壓成零：壓成零的話，
      裡面的欄位仍然接得到鍵盤焦點，使用者會按著 Tab 掉進一塊他明明已經收起來的東西裡。

      它**仍然掛著**，只是看不見：裡面的欄位可能正在等一份清單，回來時要改掉選著的那一個。
      整塊拿掉的話，那一次更正就送不出去——窄螢幕上控制項一開始就收著，
      於是圖會停在一個清單上沒有的標的，直到使用者把控制項打開為止。
    -->
    <div
