 ...
 */
export class AvailableStrategyScriptsDto {
  constructor(
    /** 自己寫的那些，帶算式，改得動。 */
    public readonly mine: readonly StrategyScriptDto[],
    /** 從市集加入的那些，不帶算式，唯讀。 */
    public readonly adopted: readonly PublishedStrategyScriptDto[],
  ) {}
}
