...
import type { StrategyScriptParameterValueOptionDto } from '~/domain/models/dto/strategy-script-parameter-value-option-dto'
 ...
 */
export class StrategyScriptParameterFieldDto {
  constructor(
    public readonly parameter: StrategyScriptParameterDto,
    /** 用打的還是用挑的。是非用挑的——「填 0 或 1」是系統內部的約定，不該漏到畫面上。 */
    public readonly control: 'number' | 'options',
    /** 用挑的那一種挑得到哪幾個。用打的那一種是空的。 */
    public readonly valueOptions: readonly StrategyScriptParameterValueOptionDto[],
