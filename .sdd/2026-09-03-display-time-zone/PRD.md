...
- **Primary Role(s):** 策略腳本研究者（專案作者本人），人在台北，看的是世界標準時間的資料。
...
**As a** 策略腳本研究者, **I want** 在操作台頂欄選一個時區,
...
**As a** 策略腳本研究者, **I want** 畫面上的時間都用我選的時區呈現,
...
**As a** 策略腳本研究者, **I want** 我填進去的時間就被當成我選的時區,
...
**As a** 策略腳本研究者, **I want** 這台瀏覽器記得我選的時區,
