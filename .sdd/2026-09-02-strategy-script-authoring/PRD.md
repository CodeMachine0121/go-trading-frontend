...
**As a** 策略腳本研究者, **I want** 只撰寫算式的內容、外框交給畫面,
...
**As a** 策略腳本研究者, **I want** 從清單挑出這次要算的指標值種類,
...
**As a** 策略腳本研究者, **I want** 一鍵得到一段當下種類能直接跑的範例內容,
...
**As a** 策略腳本研究者, **I want** 內容區有著色、自動縮排與常用片段,
...
**As a** 策略腳本研究者, **I want** 結果的呈現對得上種類,
