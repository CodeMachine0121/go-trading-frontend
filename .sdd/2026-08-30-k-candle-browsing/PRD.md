...
- **Primary Role(s):** 策略腳本研究者（專案作者本人）——單人使用，同時也是資料的維護者。
...
**As a** 策略腳本研究者, **I want** 指定交易標的與查詢區間看到該區間的 K 線,
...
**As a** 策略腳本研究者, **I want** 每根 K 線都標示漲跌,
...
**As a** 策略腳本研究者, **I want** 條件不合法時畫面直接告訴我,
...
**As a** 策略腳本研究者, **I want** 查詢失敗時知道是我的條件有問題還是後端沒開,
...
**As a** 策略腳本研究者, **I want** 一進畫面就有合理的預設區間、查詢時看得到進度,
